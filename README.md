...
Interactive documentation is available at `/docs` when the server is running (Swagger UI, auto-generated from the OpenAPI 3.1 spec at `/openapi.json`).

For developer documentation on the architecture, provider framework, and individual providers, see the [docs/](docs/) directory.
