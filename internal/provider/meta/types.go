...
type VersionInfo struct {
	...
	BuildDate  string `json:"build_date" example:"2026-02-18T12:00:00Z" doc:"Build timestamp"`
	Branch     string `json:"branch" example:"main" doc:"Git branch at build time"`
	CommitHash string `json:"commit_hash" example:"a1b2c3d" doc:"Short git commit hash"`
}
...
type BuildInfo struct {
	GoVersion string `json:"go_version" example:"go1.25.0" doc:"Go toolchain version"`
...
type RuntimeInfo struct {
	...
	BinaryPath string    `json:"binary_path" example:"/usr/local/bin/aether-webd" doc:"Path to the running binary"`
	StartTime  string    `json:"start_time" example:"2026-02-18T12:00:00Z" doc:"Server start time (RFC 3339)"`
...
type SecurityConfig struct {
	TLSEnabled       bool `json:"tls_enabled" example:"false" doc:"Whether TLS is enabled"`
	TLSAutoGenerated bool `json:"tls_auto_generated" example:"false" doc:"Whether the TLS certificate was auto-generated"`
	MTLSEnabled      bool `json:"mtls_enabled" example:"false" doc:"Whether mutual TLS is enabled"`
	TokenAuthEnabled bool     `json:"token_auth_enabled" example:"true" doc:"Whether bearer token authentication is enabled"`
	RBACEnabled      bool     `json:"rbac_enabled" example:"false" doc:"Whether RBAC is enabled"`
	CORSOrigins      []string `json:"cors_origins,omitempty" doc:"Allowed CORS origins (empty = CORS disabled)"`
}

// StorageConfig holds persistent storage configuration.
type StorageConfig struct {
	DataDir string `json:"data_dir" example:"/var/lib/aether-webd" doc:"Directory for persistent state database"`
}
...
type AppConfig struct {
	ListenAddress string         `json:"listen_address" example:"127.0.0.1:8186" doc:"Server listen address"`
	DebugEnabled  bool           `json:"debug_enabled" example:"false" doc:"Whether debug mode is enabled"`
...
type ConfigInfo struct {
	AppConfig
	SchemaVersion int `json:"schema_version" example:"2" doc:"Current database schema version"`
}
...
type StoreInfo struct {
	...
	FileSizeBytes int64             `json:"file_size_bytes" example:"524288" doc:"Database file size in bytes"`
	SchemaVersion int               `json:"schema_version" example:"2" doc:"Current schema migration version"`
